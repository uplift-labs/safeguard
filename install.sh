...
# Ensure .safeguard/ is in the target repo's .gitignore
GITIGNORE="$TARGET/.gitignore"
if [ ! -f "$GITIGNORE" ] || ! grep -qxF '/.safeguard/' "$GITIGNORE"; then
  printf '\n# Safeguard — generated by safeguard install.sh\n/.safeguard/\n' >> "$GITIGNORE"
  printf '[install] added /.safeguard/ to %s\n' "$GITIGNORE"
fi
